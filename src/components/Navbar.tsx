      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-[4.25rem] z-[90] flex flex-col bg-[#fafbff] p-8 sm:top-20 lg:hidden"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            >
              ...
              <div className="mt-8 text-center text-[11px] font-bold uppercase tracking-[0.22em] text-on-surface-variant/45">
