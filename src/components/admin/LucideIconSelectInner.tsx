...
/**
 * Full Lucide resolution (including custom names). Loaded lazily so public bundles stay small.
 */
export function LucideIconSelectInner({ value, onChange, options, id }: LucideIconSelectProps) {
