...
export const TRADEMARK_SUB_SERVICES: SubServicePageContent[] = [
  {
    id: "trademark-filing",
    title: "Trademark Registration",
    heroTitle: "Protect Your Brand Legally Across India",
    shortDescription:
      "Secure your business name, logo, slogan, or brand identity with professional trademark registration services. We handle the complete process from trademark search to filing and objection handling, helping you protect your brand with confidence.",
    whyChooseHeading: "Why Trademark Registration is Important",
    whyChooseIntro:
      "A registered trademark gives your business exclusive legal rights and helps prevent unauthorised use of your brand identity.",
    whyChooseFeatures: [
      {
    ...
    documentsRequired: [
      "PAN Card and Aadhaar Card of Applicant or Authorized Signatory",
      "Business Registration Proof such as Company Incorporation Certificate, LLP Certificate, or Partnership Deed",
      "Logo or Trademark Copy",
    ...
    benefitsHeading: "Benefits of Trademark Registration",
    registrableItemsIntro: "You can register:",
    documentsIntro: "The following documents are generally required for trademark registration for individuals, startups, LLPs, and companies:",
    ctaSubtitle: "We handle the complete trademark registration process including trademark search, filing, objection handling, hearing support, and renewal services, helping your brand stay protected and legally secure.",
    ctaTitle: "Register Your Trademark Today"
  },
  {
    id: "trademark-objection",
    title: "Trademark Objection",
    heroTitle: "Resolve Trademark Objections with Expert Legal Support",
    shortDescription:
      "Received a trademark objection from the Trademark Registry? Don't worry. We help you draft strong legal replies, handle objections under Section 9 & 11, and improve the chances of trademark approval with complete professional support.",
    whyChooseHeading: "Why Choose Our Trademark Objection Service?",
    whyChooseFeatures: [
      {
    ...
    labeledSections: [
      {
        title: "Common Types of Trademark Objections",
        items: [
          {
    ...
    benefitsHeading: "Benefits of Professional Trademark Objection Handling",
    documentsIntro: "The following documents are generally required:",
    ctaSubtitle: "We handle the complete trademark objection process including examination report analysis, legal drafting, objection filing, hearing support, and follow-up with the Trademark Registry, helping your brand move towards successful registration.",
    ctaTitle: "Resolve Your Trademark Objection Today"
  },
  {
    id: "trademark-opposition",
    title: "Trademark Opposition",
    heroTitle: "Protect Your Brand Against Similar Trademark Applications",
    shortDescription:
      "If someone applies for a trademark that is similar to your brand, you can legally oppose its registration. We provide complete support for trademark opposition filing, legal drafting, evidence preparation, hearings, and end-to-end opposition management.",
    whyChooseHeading: "Why Choose Our Trademark Opposition Service?",
    whyChooseFeatures: [
      {
    ...
    labeledSections: [
      {
        title: "Who Can File a Trademark Opposition?",
        bullets: [
    ...
    documentsRequired: [
      "Trademark Application Number",
      "Copy of Trademark Journal Publication",
      "Opponent's Trademark Registration Certificate (if available)",
    ...
    benefitsHeading: "Benefits of Trademark Opposition",
    documentsIntro: "The following documents are generally required:",
    ctaSubtitle: "We handle the complete trademark opposition process including trademark monitoring, legal drafting, TM-O filing, evidence preparation, hearings, and trademark protection strategy, helping your brand stay legally protected.",
    ctaTitle: "File Trademark Opposition with Expert Support"
  },
  {
    id: "trademark-objection-reply",
    title: "Response to Trademark Objection",
    heroTitle: "Reply to Trademark Objections with Expert Legal Support",
    shortDescription:
      "Received a trademark objection from the Trademark Registry? We help you draft and file professional trademark objection replies with proper legal reasoning and supporting documents, improving the chances of successful trademark registration.",
    whyChooseHeading: "Why Choose Our Trademark Objection Reply Service?",
    whyChooseFeatures: [
      {
    ...
    labeledSections: [
      {
        title: "Common Trademark Objections",
        items: [
          {
            title: "Section 9 Objection",
    ...
    benefitsHeading: "Benefits of Professional Trademark Objection Reply",
    documentsIntro: "The following documents are generally required:",
    ctaSubtitle: "We handle the complete trademark objection reply process including examination report analysis, legal drafting, online filing, hearing support, and trademark follow-up, helping your brand move closer to successful registration.",
    ctaTitle: "File Your Trademark Objection Reply Today"
  },
  {
    id: "trademark-infringement",
    title: "Trademark Infringement",
    heroTitle: "Protect Your Brand Against Unauthorised Usage",
    shortDescription:
      "If someone is using your brand name, logo, packaging, or trademark without permission, it may amount to trademark infringement. We provide complete legal support for infringement notices, brand protection, evidence collection, and legal action to help safeguard your business identity.",
    whyChooseHeading: "Why Choose Our Trademark Infringement Service?",
    whyChooseFeatures: [
      {
    ...
    labeledSections: [
      {
        title: "Common Types of Trademark Infringement",
        items: [
          {
    ...
    documentsRequired: [
      ...
      "Proof of Trademark Usage",
      "Invoices and Business Proof",
      "Screenshots or Photographs of Infringement",
    ...
    benefitsHeading: "Benefits of Taking Action Against Trademark Infringement",
    documentsIntro: "The following documents are generally required:",
    ctaSubtitle: "We help businesses take quick and effective action against trademark infringement through legal notices, evidence support, trademark monitoring, and legal enforcement, helping your brand stay protected and trusted.",
    ctaTitle: "Protect Your Trademark Today"
  },
  {
    id: "trademark-renewal",
    title: "Trademark Renewal",
    heroTitle: "Renew Your Trademark and Keep Your Brand Protected",
    shortDescription:
      "Trademark renewal helps you continue the legal protection of your brand name, logo, slogan, and business identity. We provide complete support for online trademark renewal, restoration, document filing, and renewal status tracking to ensure uninterrupted trademark protection.",
    whyChooseHeading: "Why Choose Our Trademark Renewal Service?",
    whyChooseFeatures: [
      {
    ...
    labeledSections: [
      {
        title: "When Should Trademark Renewal Be Filed?",
        items: [
          {
            title: "Before Expiry",
      ...
      },
      {
        ...
        intro: "Trademark renewal fees generally depend on the filing type and renewal timeline.",
        items: [
          {
      ...
      },
      {
        ...
        bullets: [
          "Trademark protection may expire",
    ...
    benefitsHeading: "Benefits of Trademark Renewal",
    documentsIntro: "The following documents are generally required:",
    ctaSubtitle: "We handle the complete trademark renewal process including trademark verification, TM-R filing, restoration support, renewal tracking, and certificate assistance, helping your brand remain legally protected without interruption.",
    ctaTitle: "Renew Your Trademark Today"
  },
  {
    id: "trademark-hearing",
    title: "Trademark Hearing",
    heroTitle: "Professional Support for Trademark Hearings and Legal Representation",
    shortDescription:
      "Received a trademark hearing notice from the Trademark Registry? We provide complete support for trademark hearing preparation, legal arguments, documentation, and representation to help improve the chances of trademark approval.",
    whyChooseHeading: "Why Choose Our Trademark Hearing Service?",
    whyChooseFeatures: [
      {
    ...
    keyPointsHeading: "The hearing gives the applicant an opportunity to:",
    keyPoints: [
    ...
    labeledSections: [
      {
        title: "Common Reasons for Trademark Hearing",
        items: [
          {
    ...
    benefitsHeading: "Benefits of Professional Trademark Hearing Support",
    documentsIntro: "The following documents are generally required:",
    ctaSubtitle: "We handle the complete trademark hearing process including hearing preparation, legal drafting, written submissions, representation, and follow-up with the Trademark Registry, helping your brand move closer to successful registration.",
...
export function getTrademarkSubService(id: string): SubServicePageContent | undefined {
  ...
  return TRADEMARK_SUB_SERVICES.find((s) => s.id.toLowerCase() === normalized);
}
